...
const webpackConfig = {
  ...
  entry: {
    crowdFunding:['./client/pages/crowdFunding/index.js',hotMiddlewareScript],
    index:['./client/pages/index/index.js',hotMiddlewareScript],
  ...
  output: {
    ...
    publicPath: '/fas-sys/dist/' //资源上下文路径
  },
